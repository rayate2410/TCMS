...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExecutionTask.browsers'
        db.alter_column(u'execution_executiontask', 'browsers', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'ExecutionTask.browsers'
        db.alter_column(u'execution_executiontask', 'browsers', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
    ...
    models = {
        ...
        u'execution.executiontask': {
            ...
            'browsers': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
